    ...
    switch (phase_++ % n_phase) {
        case Phase::CHR_INIT:
            ...
            */
            ...
            break;
        case Phase::CHR_DISPATCH:phase_++;
            verify(phase_ % n_phase == Phase::CHR_FAST);
            PreAccept();
            break;
        case Phase::CHR_FAST:
            if (fast_path_) {
                verify(phase_ % n_phase == Phase::CHR_DECIDE);
                Commit();
            } else {
            ...
            // TODO
            break;
        case Phase::CHR_FALLBACK:verify(phase_ % n_phase == Phase::CHR_DECIDE);
            Commit();
            break;
        case Phase::CHR_DECIDE:verify(phase_ % n_phase == Phase::CHR_INIT); //overflow
